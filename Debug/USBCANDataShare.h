...
#if 1
EXTERNC _declspec(dllimport) void CANDS_ResetSharedBuffer(void);
EXTERNC _declspec(dllimport) void CANDS_WriteSharedBuffer(const PCANDS_CAN_OBJ pObj);
EXTERNC _declspec(dllimport) BOOL CANDS_ReadSharedBuffer(PCANDS_CAN_OBJ pObj);
#else
